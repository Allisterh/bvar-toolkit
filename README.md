...
| Which time-varying parameter VAR, by marginal likelihood or DIC | Chan & Eisenstat (2018, JAE) | `chan_eisenstat2018_jae_mltvpsv` | `run_all('TVP-SV',…)`, `run_ml` |
...
| `bvar.ml` | Marginal likelihoods: Chib's method for the models of Chan (2020, JBES) (`kron_bvar*`), adaptive importance sampling for those of Chan (2023, JoE) (`mlvarsv_*`), importance sampling for the time-varying, constant-coefficient and regime-switching VARs of Chan and Eisenstat (2018, JAE) (`mltvpsv_*`), the closed form under the asymmetric conjugate prior (`acp`), and the integrated likelihoods and log densities they share. |
