...
% parameters, subject to linear restrictions M*y = z on the stacked data.
%
...
% M*y = z exactly. One call consumes Nm*ndraws standard normals. Written for this toolkit.
%
% See:
