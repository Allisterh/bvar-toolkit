...
| [Does Modeling the Volatility Improve My Forecasts?](forecasting/) | `bvar.models.var_csv`, `bvar.models.var_sv`, `bvar.forecast.simulate` | Carriero, Clark and Marcellino (2016); Chan, Koop and Yu (2024) |
